                            ...
                            <div class="col-md-10">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form action="{{ route('add.cash')}}" method="post" class="form-horizontal" role="form">
                                        	@csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="number" name="cash_amount" class="form-control" id="inputEmail3" placeholder="Cash Amount">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">Cash Source</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="cash_source" class="form-control" id="inputEmail3" placeholder="Where You Expense">
                                                </div>
                                            </div>
